...
public class EfficientDocument extends Document {
	...
	private void processText() {
		...
		for (String i : tokens) {
			if (isWord(i)) {
				...
				numWords++;
				int syllablecount = super.countSyllables(i);
	...
	public int getNumSentences() {
		...
		//System.out.println("no of sentences" + numSentences);
		return numSentences;
	}
	...
	public int getNumSyllables() {
		// TODO: write this method. Hint: It's simple
	//	System.out.println("no of syllables" + numSyllables);
		return numSyllables;
	}
